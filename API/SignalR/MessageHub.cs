...
public class MessageHub(IUnitOfWork unitOfWork, IMapper mapper,
     IHubContext<PresenceHub> pressenceHub) : Hub
{
    ...
    public async Task SendMessage(CreateMessageDto createMessageDto) 
    {
        ...
        if(recipient == null || sender == null || sender.UserName == null || recipient.UserName == null) throw new HubException("Cannot send a messsage at this time");
        ...
        else 
        {
            ...
            {
                await pressenceHub.Clients.Clients(connections).SendAsync("NewMessageReceived", 
